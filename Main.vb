...
Public Class Main
    Public Const ApplicationName As String = "Office Installer"
    Public Const ErrorLog As String = "Office.installer..log"
    ...
    Public Const DefaultYear As String = "2024"
    ...
    Private Sub Main_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ComboBox_Year.Items.Add("2016 (Instable)")
    ...
    Private Async Function CheckForUpdates() As Task(Of String)
        ...
        Try
            ' Check for updates
            Dim updater As New GitHubRepoUpdater("danbenba", "OmniTools")
    ...
    Private Async Sub LinkLabel_CheckForUpdates_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel_CheckForUpdates.LinkClicked
        ...
        If latestVersion IsNot Nothing AndAlso New Version(latestVersion) > New Version(Application.ProductVersion) Then
            ...
            If result = DialogResult.Yes Then
                ...
                TryStartProcess("https://github.com/asheroto/OmniTools/releases")
            End If
        Else
    ...
    Private Sub LinkLabel_Repo_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel_Repo.LinkClicked
        ...
        TryStartProcess("https://github.com/danbenba/OmniTools")
    End Sub
    ...
    Private Sub CountdownLabel_Click(sender As Object, e As EventArgs) Handles CountdownLabel.Click
